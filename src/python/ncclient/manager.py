...
#     "urn:ietf:params:netconf:capability:url:1.0?scheme=http,ftp,file,https,sftp",
    ...
    "http://www.huawei.com/netconf/capability/active/1.0",                                          #maohongsen
...
#     "http://www.huawei.com/netconf/capability/exchange/1.0",                                        #azam
...
OPERATIONS = {
    ...
    "execute_action":operations.ExecuteAction                           #maohongsen
}
