#
# XML-RPC SERVER
# $Id: //modules/xmlrpclib/xmlrpc_handler.py#4 $
#
...
import http_server # medusa components
import xmlrpclib
...
class xmlrpc_handler:
    ...
    def match (self, request):
        # Note: /RPC2 is not required by the spec.  Feel free to
        # override this method if you want to use an other URL.
